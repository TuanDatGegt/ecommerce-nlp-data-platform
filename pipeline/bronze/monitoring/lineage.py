...
from configs.settings import MINIO_BUCKET_NAME, LINEAGE_OBJECT_NAME
...
def load_lineage():
    ...
    try:
        storage_client.download_file(bucket_name=MINIO_BUCKET_NAME, object_name=LINEAGE_OBJECT_NAME, local_path=local_file)
...
def save_lineage(lineage_data):
    ...
    storage_client.upload_file(bucket_name=MINIO_BUCKET_NAME, object_name=LINEAGE_OBJECT_NAME, local_path=local_file)
